            ...
            using (StreamReader streamReader = new StreamReader(path))
            {
                while (!streamReader.EndOfStream)
                {
                    ...
                    switch (type)
                    {
                        ...
                        // face
                        case "f":
                            HashSet<Vertex> faceVertices = new HashSet<Vertex>();
                            foreach (string w in words)
                            {
                                ...
                                faceVertices.Add(new Vertex(vertices[index].X, vertices[index].Y, vertices[index].Z));
                            ...
                            faces.Add(new Face(faceVertices, colors[faces.Count % colors.Count].ToArgb(), center));
